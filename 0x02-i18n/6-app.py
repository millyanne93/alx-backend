#!/usr/bin/env python3
"""
A simple Flask app demonstrating
localization and user-based content.
"""
...
class Config(object):
    ...
    Defines available languages and default
    locale and timezone.
    """
    LANGUAGES = ['en', 'fr']
...
def get_user():
    """
    Retrieves a user dictionary based on the
    'login_as' URL parameter.
    Returns None if the user ID is not
...
def get_locale():
    ...
    3. Best match from the 'Accept-Language'
    request header.
    4. Default locale.
